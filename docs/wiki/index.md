...
- [[2026-08-17]]: Compiled & diagnosed 5 core issues in StashStats; formulated batch fix plan.
...
- [[codebase-architecture]]: Package structure, `src/stashstats` layout, web UI layers, and conventions.
...
- [[consumption-velocity-analytics]]: Stash burn rate calculation, lifespan horizon projections, and net inflow/outflow analysis.
...
- [[history-model]]: Point-in-time usage logs, quantity adjustments, and ledger balance timeline.
- [[common-models]]: Shared sub-models (`Paginator`, `Photo`, `FiberType`, `YarnWeight`, `YarnCompany`).
