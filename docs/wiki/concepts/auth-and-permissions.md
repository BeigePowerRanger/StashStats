...
The Ravelry API provides multiple authentication mechanisms depending on application architecture, scope, and [[user-model|user model]].
...
- **Use Case**: Personal scripts, local analytics, CLI tools, and single-user apps like [[codebase-architecture|StashStats]].
